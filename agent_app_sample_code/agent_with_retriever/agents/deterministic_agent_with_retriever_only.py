...
# MAGIC %md
# MAGIC # Multi-turn RAG Chain
# MAGIC
# MAGIC This is a multi-turn conversation RAG chain. Conversation history is used as context to follow-up questions from a user.
# MAGIC
# MAGIC This chain is in a separate file as the notebook chain is registered via [`mlflow.log_model`](https://mlflow.org/docs/latest/python_api/mlflow.sklearn.html#mlflow.sklearn.log_model).
...
prompt = ChatPromptTemplate.from_messages(
    [
        (  # System prompt contains the instructions
            "system",
            generator_config.get("llm_system_prompt_template"),
        ),
...
model = ChatDatabricks(
    ...
    extra_params=generator_config.get("llm_parameters"),
)
